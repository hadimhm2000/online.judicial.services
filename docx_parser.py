...
def docx_to_plain_text(filepath: str) -> str:
    ...
    برای نمایش در پیش‌نمایش تلگرام استفاده می‌شود.
    """
    try:
        doc = Document(filepath)
    except Exception as e:
...
async def download_docx_from_telegram(bot, file_id: str, user_id: int) -> str:
    """
    دانلود فایل ورد از تلگرام و ذخیره محلی.
