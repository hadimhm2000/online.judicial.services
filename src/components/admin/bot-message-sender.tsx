            ...
            <div className="p-5 space-y-4">
              ...
              <div className="space-y-1.5 relative">
                ...
                <div className="relative">
                  ...
                  <Input
                    placeholder="نام یا شناسه تلگرام..."
                    value={userSearch}
                    ...
                    <div className="absolute top-full mt-1 left-0 right-0 z-50 bg-popover border rounded-lg shadow-lg max-h-48 overflow-y-auto">
                      {userSuggestions.map((user) => (
                        ...
                        >
                          ...
                          <span className="text-xs text-muted-foreground font-mono" dir="ltr">{user.telegramId}</span>
                        </button>
                      ))}
                    </div>
                  )}
              ...
              <div className="space-y-1.5">
                <label className="text-[11px] font-medium text-muted-foreground">{'شناسه تلگرام'}</label>
                <Input
                          ...
                          <div className="flex-1 min-w-0 space-y-1.5">
                            <div className="flex items-center justify-between gap-2">
                              <div className="flex items-center gap-2 min-w-0">
                                <span className="text-sm font-medium truncate">{msg.fullName || msg.telegramId}</span>
