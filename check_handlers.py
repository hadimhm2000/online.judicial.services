...
async def check_bulk_file_upload_handler(message: Message, state: FSMContext):
    ...
    try:
        ...
        from keyboards import flow_type_kb
        try:
            await message.answer(summary, reply_markup=flow_type_kb, parse_mode="Markdown")
        except Exception:
...
async def _go_to_check_preview(message: Message, state: FSMContext):
    ...
    try:
        await message.answer(preview, reply_markup=check_confirm_kb, parse_mode="Markdown")
    except Exception:
